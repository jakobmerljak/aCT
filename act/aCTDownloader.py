...
class aCTDownloader:
    ...
    def checkJobs(self,trfstatus='inarc'):
        ...
        jobs=self.dbpanda.getJobs("( pstatus='running' or pstatus='starting' or pstatus='transferring' ) and arcjobid like 'gsiftp%' and trfstatus like '"+trfstatus+"' and "+self.db.timeStampLessThan("tarcstatus", self.conf.get(['jobs','checkinterval'])) + " limit 100000")
