...
class aCTValidatorCondor(aCTATLASProcess):
    ...
    def validateFinishedJobs(self):
        ...
        for job in jobstoupdate:
            ...
            self.dbcondor.updateCondorJobLazy(job['arcjobid'], desc)
    ...
    def cleanResubmittingJobs(self):
        ...
        Move actpandastatus to starting and set arcjobid to NULL.
        ...
        select = "actpandastatus='toresubmit' and condorjobs.id=pandajobs.arcjobid and siteName in %s limit 100" % self.sitesselect
        columns = ["pandajobs.arcjobid", "pandajobs.pandaid", "condorjobs.ClusterId", "condorjobs.condorstate"]
