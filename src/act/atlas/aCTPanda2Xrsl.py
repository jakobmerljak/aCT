    ...
    def setInputs(self):
        ...
        if 'inFiles' in self.jobdesc and not self.truepilot:
            ...
            if self.catalog.find('rucio://') == 0:
                for filename, scope, dsn, guid in zip(self.jobdesc['inFiles'][0].split(","), self.jobdesc['scopeIn'][0].split(","), self.jobdesc['realDatasets'][0].split(","), self.jobdesc['GUID'][0].split(",")):
